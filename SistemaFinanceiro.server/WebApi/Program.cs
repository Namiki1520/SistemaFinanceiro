...
builder.Services.AddSingleton<InterfaceReceita, RepositorioReceita>();
...
builder.Services.AddSingleton<IReceitaServico, ReceitaServico>();
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
             .AddJwtBearer(option =>
             {
                 option.TokenValidationParameters = new TokenValidationParameters
                 {
                     ...
                     IssuerSigningKey = JwtSecirityKey.Create("Secret_Key-12345678")
                 };
